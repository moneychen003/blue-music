<script lang="ts">
  ...
  import AddCurrentMusicBtn from '@/components/common/AddCurrentMusicBtn.svelte'
  import LyricBtn from '@/components/common/LyricBtn.svelte'
  import DesktopLyricBtn from '@/components/common/DesktopLyricBtn.svelte'
  import QualityBtn from '@/components/common/QualityBtn.svelte'
