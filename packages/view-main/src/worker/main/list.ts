...
export type SortFieldName = 'name' | 'singer' | 'albumName' | 'interval' | 'createTime' | 'updateTime' | 'year' | 'trackNo'
...
export const sortListMusicInfo = async (
  ...
  switch (sortType) {
    ...
    case 'up':
      ...
      } else if (fieldName == 'createTime' || fieldName == 'updateTime' || fieldName == 'year' || fieldName == 'trackNo') {
        list.sort((a, b) => {
