...
const assetsAll = {
  ...
  web: {
    dev: [
      ...
      [path.join(rootPath, 'packages/view-main/public'), path.join(rootPath, 'packages/web-server/server/public')],
    ],
    prod: [
      [path.join(rootPath, 'packages/shared/theme/theme_images'), path.join(rootPath, 'build/public/theme_images')],
      [path.join(rootPath, 'packages/view-main/public'), path.join(rootPath, 'build/public')],
