...
declare global {
  namespace AnyListen {
    ...
    interface AppSetting {
       ...
       * 优先播放的音质
       */
      'player.playQuality': AnyListen.Music.Quality
      ...
      'desktopLyric.x': number
      'desktopLyric.y': number
      'desktopLyric.isLockScreen': boolean
      'desktopLyric.isDelayScroll': boolean
      'desktopLyric.scrollAlign': 'center' | 'top'
       ...
       * 下载音质(与播放音质独立)
       */
      'download.quality': Music.Quality
       ...
       * 是否跟随系统代理
       */
      'network.proxy.followSystem': boolean
